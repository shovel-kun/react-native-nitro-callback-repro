...
namespace margelo::nitro::testview {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/testview/Func_void;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/testview/Func_void_cxx;";
