...
namespace margelo::nitro::testview {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/testview/HybridTestViewSpec;";
  ...
  public:
    ...
    std::function<void()> getOnColorChange() override;
    void setOnColorChange(const std::function<void()>& onColorChange) override;
