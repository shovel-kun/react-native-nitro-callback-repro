...
public class HybridTestViewSpec_cxx {
  /**
   * The Swift <> C++ bridge's namespace (`margelo::nitro::testview::bridge::swift`)
   * from `TestView-Swift-Cxx-Bridge.hpp`.
   * This contains specialized C++ templates, and C++ helper functions that can be accessed from Swift.
   */
  public typealias bridge = margelo.nitro.testview.bridge.swift
   ...
   */
  private var __cxxPart: bridge.std__weak_ptr_margelo__nitro__testview__HybridTestViewSpec_
   ...
   * The C++ part is a `std::shared_ptr<margelo::nitro::testview::HybridTestViewSpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_margelo__nitro__testview__HybridTestViewSpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if cachedCxxPart.__convertToBool() {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_margelo__nitro__testview__HybridTestViewSpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_margelo__nitro__testview__HybridTestViewSpec_(newCxxPart)
      return newCxxPart
    }
  }
  ...
  public final var onColorChange: bridge.Func_void {
    @inline(__always)
    get {
      return { () -> bridge.Func_void in
        let __closureWrapper = Func_void(self.__implementation.onColorChange)
        return bridge.create_Func_void(__closureWrapper.toUnsafe())
      }()
    }
    @inline(__always)
    set {
      self.__implementation.onColorChange = { () -> () -> Void in
