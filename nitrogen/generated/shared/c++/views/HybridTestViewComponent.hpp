...
namespace margelo::nitro::testview::views {
  ...
  public:
    ...
    CachedProp<std::function<void()>> onColorChange;
    CachedProp<std::optional<std::function<void(const std::shared_ptr<margelo::nitro::testview::HybridTestViewSpec>& /* ref */)>>> hybridRef;
